...
[Generator]
public class AsyncPSCmdletGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterPostInitializationOutput(ctx =>
        {
            ...
            ctx.AddSource(
                "AsyncPSCmdletAttribute.g.cs",
                SourceText.From(Embedded.AsyncPSCmdletAttribute, Encoding.UTF8));
        });
        ...
        context.RegisterSourceOutput(templateProvider, (spc, data) =>
        {
            ...
            spc.AddSource(
                "AsyncPSCmdlet.g.cs",
                GenerateSourceText(Embedded.AsyncPSCmdlet, replacementNamespace));
            spc.AddSource(
                "AsyncPSCmdletBase.g.cs",
                GenerateSourceText(Embedded.AsyncPSCmdletBase, replacementNamespace));
            spc.AddSource(
                "AsyncPSCmdletBase.PipelineStop.g.cs",
                GenerateAsyncPSCmdletBasePartial(replacementNamespace, hasPipelineStopToken));
        });

        // Find cmdlet classes with [AsyncPSCmdlet]
        IncrementalValuesProvider<CmdletInfo?> cmdletClasses = context.SyntaxProvider
            .ForAttributeWithMetadataName(
                "Jborean.PwshAsync.AsyncPSCmdletAttribute",
    ...
    private static ImmutableArray<PropertyInfo> DiscoverProperties(INamedTypeSymbol classSymbol)
    {
        ...
        // Walk up inheritance chain until AsyncPSCmdlet or object
        while (currentType != null && currentType.SpecialType != SpecialType.System_Object)
        {
            // Stop at AsyncPSCmdlet base
            if (currentType.Name == "AsyncPSCmdlet" || currentType.Name == "AsyncPSCmdletBase")
            {
                break;
            }
    ...
    private static string GeneratePSCmdletWrapper(CmdletInfo cmdlet, string generatedNamespace)
    {
        ...
        sb.AppendLine($"        : global::{generatedNamespace}.AsyncPSCmdletBase<{cmdlet.ClassName}>");
        sb.AppendLine("    {");
    ...
    private static SourceText GenerateAsyncPSCmdletBasePartial(string replacementNamespace, bool hasPipelineStopToken)
    {
        StringBuilder sb = new();
        sb.AppendLine("// <auto-generated/>");
        sb.AppendLine("// This file was automatically generated by Jborean.PwshAsync.");
        ...
        if (hasPipelineStopToken)
        {
            ...
            sb.AppendLine("    public abstract partial class AsyncPSCmdletBase<TAsyncCmdlet>");
            sb.AppendLine("    {");
